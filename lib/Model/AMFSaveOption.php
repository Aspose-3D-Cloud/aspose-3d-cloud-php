...
/**
 * AMFSaveOption Class Doc Comment
 *
 * @category Class
 * @package  Aspose\ThreeD\Cloud
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AMFSaveOption extends SaveOptions 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AMFSaveOption';
     ...
     *
     * @param bool $enable_compression Whether to use compression to reduce the final file size, default value is true.
     *
     * @return $this
     */
